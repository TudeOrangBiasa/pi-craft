...
scope: "tool:edit(*.{ts,tsx,js,jsx,mts,cts,mjs,cjs}), tool:replace(*.{ts,tsx,js,jsx,mts,cts,mjs,cjs}), tool:insert(*.{ts,tsx,js,jsx,mts,cts,mjs,cjs}), tool:write(*.{ts,tsx,js,jsx,mts,cts,mjs,cjs})"
interruptMode: never
astCondition:
  - "if ($X) clearTimeout($X)"
  - "if ($X) { clearTimeout($X) }"
