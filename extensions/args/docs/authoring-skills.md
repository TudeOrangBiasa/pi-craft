...
| `argument-hint` | Not read by `pi-args`. Substitution is triggered by placeholders in the body, never by a hint. Treat it as documentation for readers of your skill. |
