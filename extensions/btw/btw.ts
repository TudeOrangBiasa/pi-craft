...
export const BTW_STATE_KEY = Symbol.for("pi-btw");
...
// (packages/pi-btw/btw-messages.ts); re-exported here so the package surface is
// unchanged (packages/pi-btw/btw.test.ts / btw-ui.test.ts / btw-budget.test.ts still
...
// Modeled after pi-advisor/advisor.ts:225-336
// ---------------------------------------------------------------------------
