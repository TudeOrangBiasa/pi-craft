 ...
 *
 * globalThis-keyed (Symbol.for("pi-advisor")) so the cache survives module
 * re-import on /new, /fork, /resume (mirrors pi-btw/btw.ts). Single-slot — the
...
const ADVISOR_STATE_KEY = Symbol.for("pi-advisor");
