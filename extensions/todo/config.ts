...
import { loadJsonConfigWithLegacyFallback, validateGuidanceFields } from "./config-io.js";
...
export function loadConfig(): TodoConfig {
	return loadJsonConfigWithLegacyFallback<TodoConfig>("pi-todo");
}
 ...
 *  pi-ask-user-question). Exported for unit tests. */
